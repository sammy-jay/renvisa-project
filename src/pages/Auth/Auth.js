...
const steps = ['Step 0', 'Step 1', 'Step 2','Step 3', 'Step 4', 'Step 5', 'Step 6', 'Step 7', 'Step 8', 'Step 9',];
    ...
    <section className='auth'>
      <article className='authSideOne'>
        ...
        {steps.map((label, index) => {
          ...
          '& .MuiStepLabel-root .Mui-completed': {color: '#fff',},'& .MuiStepLabel-label.Mui-completed.MuiStepLabel-alternativeLabel':{color: 'grey.500'},'& .MuiStepLabel-root .Mui-active': {color: '#fff'},'& .MuiStepLabel-root .Mui-active .MuiStepIcon-text': {fill: 'black'}}}>
      ...
      {activeStep === 7 && (
       ...
       <div className='formers'>
           ...
           <p className='redText'>We will use this information to check your credit profile and help estimate your income</p>
